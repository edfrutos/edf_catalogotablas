...
def update_env_file(env_path, new_uri=None, use_direct_uri=False, use_local_mongodb=False):
    ...
    if use_local_mongodb:
        new_uri = 'mongodb://localhost:27017/app_catalogojoyero'
...
def main():
    ...
    if not original_uri:
        ...
        original_uri = "mongodb+srv://edfrutos:rYjwUC6pUNrLtbaI@cluster0.pmokh.mongodb.net/app_catalogojoyero?retryWrites=true&w=majority"
