...
parser.add_argument('--intervalo', type=int, default=60, help='Intervalo entre mediciones en segundos')
parser.add_argument('--duracion', type=int, default=3600, help='Duración total del monitoreo en segundos')
...
def obtener_estadisticas(client):
    ...
    return {
        ...
        'estadisticas': {
            ...
            'cola_operaciones': server_status.get('globalLock', {}).get('currentQueue', {}).get('total', 0),
