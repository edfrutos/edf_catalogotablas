...
parser = argparse.ArgumentParser(description="Actualiza el rol de un usuario en app_catalogojoyero_nueva por email o username")
...
if result.modified_count == 1:
    print("✅ Rol actualizado a admin para 'edefrutos' en 'app_catalogojoyero_nueva'")
else:
    print("⚠️ No se actualizó ningún usuario en 'app_catalogojoyero_nueva'. ¿Ya era admin o no existe?")