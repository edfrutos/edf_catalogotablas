...
"""
Script para restablecer la contraseña del usuario 'edefrutos'
"""
...
def reset_password(username_or_email, new_password):
    """Restablece la contraseña de un usuario por nombre de usuario o email"""
    try:
        ...
        logger.info(f"Contraseña actual: {usuario.get('password')[:30]}...")
        logger.info(f"Tipo de contraseña: {usuario.get('password_type')}")
        
        # Generar hash de la nueva contraseña
        password_hash = generate_password_hash(new_password)
        logger.info(f"Nuevo hash generado: {password_hash[:30]}...")
        ...
        if result.modified_count > 0:
            logger.info(f"✅ Contraseña restablecida correctamente para {username_or_email}")
...
if __name__ == "__main__":
    username_or_email = "edefrutos"
    new_password = "Edefrutos2025!"
    ...
    logger.info(f"Restableciendo contraseña para: {username_or_email}")
    logger.info(f"Nueva contraseña: {new_password}")
