...
def main():
    ...
    try:
        ...
        if is_frozen:
            ...
            logger.info(f"Modo aplicación empaquetada: usando tamaño {WINDOW_WIDTH}x{WINDOW_HEIGHT}")
        else:
            ...
            logger.info(f"Modo desarrollo: usando tamaño {WINDOW_WIDTH}x{WINDOW_HEIGHT}")
