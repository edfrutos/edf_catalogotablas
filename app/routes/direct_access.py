# Script: direct_access.py Proporciona una solución universal que funciona tanto en entorno local como en producción, sin depender de la conexión a MongoDB.]
# Uso: python3 direct_access.py [opciones]
