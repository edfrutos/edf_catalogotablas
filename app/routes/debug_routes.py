...
def debug_session():
    ...
    if current_app.config.get('ENV') != 'development' and session.get('role') != 'admin':
    ...
    session_info = {
        ...
        'app_secret_key_length': len(str(current_app.secret_key)) if current_app.secret_key else 0,
