...
class EmbeddedConfig:
    ...
    MAIL_DEFAULT_SENDER = ('EDF Catálogo de Tablas', os.getenv('MAIL_DEFAULT_SENDER_EMAIL', ''))
    MAIL_DEBUG = False
    ...
    if getattr(sys, 'frozen', False):
        ...
        UPLOAD_FOLDER = os.path.join(os.path.expanduser('~'), 'Documents', 'EDF_CatalogoTablas', 'imagenes_subidas')
        SPREADSHEET_FOLDER = os.path.join(os.path.expanduser('~'), 'Documents', 'EDF_CatalogoTablas', 'spreadsheets')
    else:
        # Desarrollo
