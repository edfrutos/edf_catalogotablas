...
class UnifiedLogger:
    ...
    def setup(self, app=None, log_dir: Optional[str] = None, log_level: int = logging.INFO):
...
def setup_unified_logging(app=None, log_dir: Optional[str] = None, log_level: int = logging.INFO):
