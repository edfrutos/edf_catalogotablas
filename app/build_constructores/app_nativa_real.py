#!/usr/bin/env python3
"""
EDF Catálogo de Tablas - Aplicación Nativa Real
Aplicación de escritorio nativa usando tkinter
Sin dependencia de servidor web o Flask
"""
...
class EDFCatalogoApp:
    def __init__(self, root):
        self.root = root
        self.root.title("EDF Catálogo de Tablas - Aplicación Nativa")
    ...
    def create_widgets(self):
        ...
        title_label = ttk.Label(
            main_frame, text="EDF Catálogo de Tablas", style="Title.TLabel"
        )
