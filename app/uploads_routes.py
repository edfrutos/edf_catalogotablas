...
import tempfile
import zipfile
from flask import Blueprint, request, send_from_directory, redirect, url_for, flash, session
from werkzeug.utils import secure_filename
from app import app, s3_client
from app.utils import allowed_file, upload_file_to_s3, get_s3_url, eliminar_archivo_imagen
from app.models import S3_BUCKET_NAME
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        # Subir a S3
        if upload_file_to_s3(filepath, filename):
...
def descargar_catalogo():
    ...
    from app.utils import get_current_spreadsheet, leer_datos_excel
                    ...
                    try:
                        ...
                        if len(s3_parts) == 2:
                            ...
                            if bucket_name == S3_BUCKET_NAME:
                                temp_img = os.path.join(tempfile.gettempdir(), os.path.basename(object_key))
                                s3_client.download_file(S3_BUCKET_NAME, object_key, temp_img)
