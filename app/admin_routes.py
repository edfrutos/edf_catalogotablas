...
from app.models import users_collection, catalog_collection
...
def admin_suspicious_users():
    ...
    suspicious = users_collection.find({"last_login": {"$exists": False}})
...
def admin_security_dashboard():
    ...
    usuarios_sin_2fa = users_collection.count_documents({"2fa_enabled": {"$ne": True}})
