    ...
    if db is None:
        ...
        try:
            ...
            if initialize_db(app):
                ...
                current_app.logger.error("[get_db] Reconexión fallida: initialize_db() devolvió False.")
        except Exception as e:
            current_app.logger.error(f"[get_db] Error crítico al intentar reconectar a la base de datos: {e}")
            db = None
    return db 

ALLOWED_EXTENSIONS = {"jpg", "jpeg", "png", "gif", "bmp", "svg", "webp", "avif", "tiff", "ico"}
